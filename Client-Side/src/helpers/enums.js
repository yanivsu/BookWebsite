...
export const bookInfoParag = `למדתי לרכוב על אופניים בגיל 20. עד כאן, סיפור פשוט יחסית, רק ש... עבורי זה היה רגע מכונן בהחלט. אני זוכרת את הרגע הזה בדיוק רב, הרגע שבו רגל אחת מובילה את השנייה וזה פשוט קורה, את דפיקות הלב הנרגשות והתחושה שניצחתי.\n   
(כשקיבלתי מנועה המאיירת את עמוד הניצחון של לירן התחושה הכתה בי שוב, כאילו השמש יצאה ממני ברגע הזה, ממש כמו באיור, בלי שום תיאום מוקדם שלנו)\n 

כשהייתי בת 8 אחי,רונאל, נהרג. רונאל הוא יצא לסיבוב בשכונה על האופניים ולא שב. מאז זוג האופניים היחיד שנותר בבית היה שלו - מצבת זיכרון עבורו. ואני, ניסיתי כמה פעמים בסמוך לעלות על אופניים, לרכוב, במסגרות כאלה ואחרות. אך זה לא צלח ולא מנע ממני יותר מדי - הנחתי את זה בצד.

במרוץ הימים, מצאתי עצמי עובדת בהולנד , ושם ... כולם רוכבים. לא יכולתי שלא להתפעל מהעובדה הזו, ואני.. אני רציתי גם.

אני זוכרת את הרגע הזה בדיוק רב, אותה השניה שבה הצלחתי והרגשתי חופשיה. לצדו אני זוכרת בדיוק רב גם נסיעה בקטע כביש קצר, כשאני רוכבת עם כיוון התנועה ושומעת רכב מתקרב אליי. בהלה אחזה בי. מחשבות ושאלות צפו באותו הרגע , כל כך הרבה מידע בשבריר אחד של שניה. 
אני זוכרת את אלו ואני זוכרת את ההחלטה לרכוב שוב, כי יש ברירה - אבל היא לא טובה מספיק.\n 

באחד המכתבים שכתבתי לאחי, הבטחתי להקדיש לו מעשיית הטוב , והרבה ממנה. הספר שכתבתי הוא לכבודו, לזכרו, לאורו.\n 

אין זה סיפור על מוות, זה סיפור על חיים. בסיפור מובא עולמי הפרטי, מה שאני מוצאת כמשמעותי וחשוב בחייו של אדם, מתוך ניסיוני החינוכי מזה שנים ומתוך ההבנה של מה אני צריכה.\n 

בסיפור בא לידי ביטוי הצורך שלנו בסביבה, בכוחה של הסביבה להאיר את חיינו ולהאיר את תכונותינו החיוביות. אנחנו אולי יכולים לבד, אבל טוב יותר ביחד! הסיפור שוזר בתוכו שימוש בתכונות ויכולות שכבר קיימות בנו ומאפשרות לנו לצמוח במקומות חדשים. זהו סיפור על חצייה של פחדים - כי החיים מלאים בהם.סיפור על נחישות על התמדה על תרגול הרי בסופו של יום, הם אלה שמכתיבים את חיינו. 
 
אין בו רע,  אין אתגר שאינו מושג. יש בו מהיומיום שלנו, של כולנו - ילדים ומבוגרים כאחד.

במסגרת סדנת התפתחות שעברתי זכיתי בתזכורת שלחצות אתגר זה בעצם קצת כמו לרכוב על אופניים - הגוף זוכר, המח זוכר וכשזה שם, זה כבר שלך.\n 

את כל אלה ועוד, ארזנו במילים, ארזנו באיורים ויצרנו מוצר אישי, רגיש, בהיר. תשומת הלב מורגשת בכל אות ובכל נקודה וכולי תקווה להפיץ את הסיפור ומסריו לכל מי שימצא בו כוח .`;

export const contants = {
  whatsapp:
    "https://api.whatsapp.com/send/?phone=972535241416&text&app_absent=0",
  facebook: "https://www.facebook.com/liran.haliezan",
  email: "mailto:linoyassoulin@gmail.com",
};
